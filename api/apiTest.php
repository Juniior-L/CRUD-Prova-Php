    ...
    <div class="container">
        ...
        <form method="post" action="tasks.php">
            ...
            <div class="input-group">
                <input type="text" name="tittle" placeholder="Titulo" value="Jogar o lixo" required>
            </div>

            <div class="input-group">
                <input type="note" name="note" placeholder="Descreva" value="Tem q jogar o lixo pô" required>
            </div>
